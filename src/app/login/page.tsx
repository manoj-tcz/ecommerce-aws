    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted text-sm">Sign in to your NovaBuy account</p>
        </div>
        ...
        <div className="p-6 rounded-2xl bg-card border border-border/60">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center"><span className="px-3 bg-card text-xs text-muted">or continue with</span></div>
          </div>
