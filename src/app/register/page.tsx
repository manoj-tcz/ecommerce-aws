          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary pr-12"
            ...
            <div className="flex items-start gap-2">
              <input
                ...
                id="terms"
                required
                className="w-4 h-4 text-primary border-gray-200 rounded focus:ring-primary mt-0.5"
              />
